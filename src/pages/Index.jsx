          ...
          <Box flex="1" bg="gray.100" p={4}>
            <Box flex="1" bg="gray.100" p={4}>
              <VStack spacing={4} h="80%">
                ...
                {activeStep === 2 && (
                  <VStack spacing={4}>
                    <FormControl isInvalid={backgroundImageError}>
                      <FormLabel htmlFor="backgroundImage">Background Image Link</FormLabel>
                      <Input id="backgroundImage" placeholder="Enter image URL" value={backgroundImage} onChange={handleBackgroundImageChange} />
